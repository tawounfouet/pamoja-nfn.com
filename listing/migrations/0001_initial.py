    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='tags', to='listing.category')),
            ],
            options={
                'verbose_name': 'Tag',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('type', models.CharField(choices=[('IND', 'Individuel'), ('COM', 'Entreprise')], max_length=3)),
                ('listing_title', models.CharField(default='', max_length=200)),
                ('company_name', models.CharField(blank=True, max_length=200, null=True)),
                ('description', models.TextField(blank=True, default='', null=True)),
                ('logo', models.ImageField(blank=True, null=True, upload_to='listing_logos/')),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('website_url', models.URLField(blank=True, default='', null=True)),
                ('business_hours', models.JSONField(blank=True, default=None, null=True)),
                ...
                ('location', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='listings', to='location.location')),
                ('profile', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='listings', to='users.profile')),
            ],
            options={
                'ordering': ['-created_at'],
            },
